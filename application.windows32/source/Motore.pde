...
//     Bottoni della difficoltà
    ...
    else if(mouseX > startX+ingombroX && mouseX < startX+ingombroX+ingombroX*1.3 && mouseY > startY+ingombroY*2+30 && mouseY < startY+ingombroY*2+65){
      if(mousePressed){
        diff = 2;
      }
    }
    ...
    fill(d1);
    text("n00b",startX+ingombroX/1.5+15,startY+ingombroY*2,ingombroX/3,26);
    fill(d2);
